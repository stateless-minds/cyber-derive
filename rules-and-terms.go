				...
				app.Div().ID("rules").Body(
					...
					app.Ul().Body(
						app.Ol().Body(
							...
							app.Li().Text("There are no defined limits. People can deliver by foot, bicycle, e-scooter or their personal car. Thus it all depends on the means of transportation in use and a personal evaluation."),
						),
					),
				),
